...
export default class CreateModal extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      show: props.show,
      content: [
        [null, null, "status_id", "", "None"],
        [null, null, "company_id", "", "None"],
        [null, null, "contract_id", "", "None"],
        [null, null, "end_city_id", "", "None"],
        ...
        [null, null, "start_city_id", "", "None"],
        [null, null, "contract_type_id", "", "None"],
        ...
        [null, null, "contract_division_id", "", "None"],
        [null, null, "end_state_province_id", "", "None"],
        ...
        [null, null, "start_state_province_id", "", "None"],
  ...
  update_content(newContent) {
    var object = this.state.content;
    object.forEach((item) => {
      var new_val = newContent[item.columnName];
      item.value = new_val;
      item.updatedValue = "";
    });
  }
