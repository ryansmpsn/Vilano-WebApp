...
const About = (props) => (
  <Jumbotron>
    ...
    <p>
      ...
      informative area to tell you exactly what we are doing. At the moment this little space right here is just so the developer
      has some white space to fill in the page. If he didn't feel weird about grabbing random text from the internet and putting
