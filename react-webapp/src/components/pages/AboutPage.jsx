...
const About = props => (
  <Jumbotron>
    ...
    <p>
      ...
      management, submitting tickets and many more things to come in the future.
      Eventually we will replace this small informative space with a proper
      landing page designed to look nice and pretty, but for now we just have
      ...
      grab random text as it would to just type this anyway.
    </p>
  </Jumbotron>
);
