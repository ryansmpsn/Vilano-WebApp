          ...
          <MDBCol lg="4" className="mb-4 mt-5">
            <MDBCard narrow className="cascading-admin-card">
              <div className="admin-up">
                <MDBBtn style={{ width: "440px" }} icon="money-bill-alt" className="mdb-color lighten-3" href="/profile">
                  Profile
                </MDBBtn>
              </div>
          ...
          <MDBCol lg="8" className="mb-r">
            <MDBCard narrow>
              ...
              <MDBCardBody className="text-center">
                <MDBRow>
                  <MDBCol md="6">
                    <MDBInput type="text" label="Company" value="Vilano Management Services, Inc." disabled />
                  </MDBCol>
                  <MDBCol md="6">
                ...
                <MDBRow>
                  ...
                  <MDBCol md="6">
                    <MDBInput type="text" label="Department" value="Sofware Development" disabled />
                  </MDBCol>
                </MDBRow>
                <MDBRow>
                  <MDBCol md="12">
