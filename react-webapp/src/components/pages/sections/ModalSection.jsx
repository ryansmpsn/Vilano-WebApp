            ...
            <MDBRow>
              <MDBCol md="3" className="mb-3">
                ...
                <div className="text-center">
                  ...
                  <MDBBtn color="primary" size="sm" onClick={this.toggle(1)}>
                    Top
                  </MDBBtn>
              ...
              <MDBCol md="3" className="mb-3">
                ...
                <div className="text-center">
                  ...
                  <MDBBtn color="primary" size="sm" onClick={this.toggle(4)}>
                    Top Left
                  </MDBBtn>
                  <MDBBtn color="primary" size="sm" onClick={this.toggle(5)}>
                    Bottom Right
                  </MDBBtn>
                  <MDBBtn color="primary" size="sm" onClick={this.toggle(6)}>
                    Bottom Left
                  </MDBBtn>
                  <MDBModal
              ...
              <MDBCol md="3" className="mb-3">
                ...
                <div className="text-center">
                  ...
                  <MDBBtn color="primary" size="sm" onClick={this.toggle(7)}>
                    Small
                  </MDBBtn>
                  <MDBBtn color="primary" size="sm" onClick={this.toggle(8)}>
                    Medium
                  </MDBBtn>
                  <MDBBtn color="primary" size="sm" onClick={this.toggle(9)}>
                    Large
                  </MDBBtn>
                  <MDBBtn color="primary" size="sm" onClick={this.toggle(10)}>
                    Fluid
                  </MDBBtn>
                  <MDBModal
              ...
              <MDBCol md="3" className="mb-3">
                ...
                <div className="text-center">
                  <h5 className="my-3">Position</h5>
                  <MDBBtn color="primary" size="sm" onClick={this.toggle(11)}>
                    Right
                  </MDBBtn>
                  <MDBBtn color="primary" size="sm" onClick={this.toggle(12)}>
                    Left
                  </MDBBtn>
                  <MDBBtn color="primary" size="sm" onClick={this.toggle(13)}>
                    Top
                  </MDBBtn>
