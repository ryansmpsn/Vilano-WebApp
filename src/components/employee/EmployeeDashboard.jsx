...
import EmployeeDrivers from "./EmployeeDrivers";
  ...
  return (
    <>
              ...
              <Card.Body>
                <ListGroup className="list-group-flush">
                  ...
                  <ListGroupItem>
                    Active Drivers
                    <Badge variant="primary" pill className="float-right">
                      <CountUp start={0} end={props.appData ? props.appData.drivers.length : 0} duration={5} />
                    </Badge>
                  </ListGroupItem>
                </ListGroup>
              </Card.Body>
      ...
      <Nav justify variant="tabs" defaultActiveKey="employee" className="pb-2 w-50 mx-auto my-3 ">
        <NavItem>
          <NavLink to="drivers" activeClassName="text-primary border-top">
            Drivers
          </NavLink>
        </NavItem>
        <NavItem>
      ...
      {props.appData && (
        <Routes>
          ...
          <Route path="drivers" element={<EmployeeDrivers drivers={props.appData.drivers} />} />
          <Route path=":employeeId" element={<EmployeeInformation contractIds={contractIds} employeeDropdowns={employeeDropdowns} />} />
          <Navigate from="/employee" to="/employee/drivers" />
        </Routes>
      )}
    </>
  );
