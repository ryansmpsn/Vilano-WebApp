      ...
      <Card.Body className="text-center">
        <Form.Group>
          <Form.Label className="border border-dark w-75">
            This is an on-the-job injury not involving a motor vehicle crash. I am a current lead driver, supervisor, manager, or a company agent for one of the following companys: Postal Fleet Services, Inc., The
          ...
          <p className="text-muted">
            <small>DISCLAIMER: We are not obligated to follow-up and or contact non-employees as described above.</small>
          </p>
          <hr />
          <Form.Row>
            ...
            <fieldset className="text-left" as={Col} md={6} sm={12}>
              <Form.Group as={Row}>
                ...
                <Col sm={2}>
                  ...
                  <Form.Check type="radio" label="Unknown" name="formHorizontalRadios" id="formHorizontalRadios3" />
                </Col>
              </Form.Group>
            </fieldset>
            <Form.Group controlId="injury" className="text-left" as={Col} md={2} sm={12}>
              <Form.Check type="checkbox" label="Injury?" />
            </Form.Group>
            <Form.Group controlId="fatality" className="text-left" as={Col} md={2} sm={12}>
              <Form.Check type="checkbox" label="Fatality?" />
            </Form.Group>
            <Form.Group controlId="towAway" className="text-left" as={Col} md={2} sm={12}>
              <Form.Check type="checkbox" label="Tow-Away?" />
            </Form.Group>
          </Form.Row>
          <div className="m-3 text-left">
            <p className="mb-3 font-weight-bold">
              If you answered yes to any of the above questions, please contact the Safety Director Immediatly.
              <a href="tel:904-824-2007"> 904-824-2007</a> (Follow Prompts if Afterhours)
            </p>
            <hr />
            <h4 className="text-center">Post Accident Drug & Alcohol Testing</h4>
            ...
            <p>
              (b) As soon as practicable following an occurrence involving a commercial motor vehicle operating on a public road in commerce, each employer shall test for controlled substances for each of its surviving
              drivers:
            </p>
            <p>(1) Who was performing safety-sensitive functions with respect to the vehicle, if the accident involved the loss of human life; or</p>
            ...
            <p>
              (d)(1) Alcohol tests. If a test required by this section is not administered within two hours following the accident, the employer shall prepare and maintain on file a record stating the reasons the test
              was not promptly administered. If a test required by this section is not administered within eight hours following the accident, the employer shall cease attempts to administer an alcohol test and shall
              prepare and maintain the same record. Records shall be submitted to the FMCSA upon request.
            </p>
            <p>
              (2) Controlled substance tests. If a test required by this section is not administered within 32 hours following the accident, the employer shall cease attempts to administer a controlled substances test,
              and prepare and maintain on file a record stating the reasons the test was not promptly administered. Records shall be submitted to the FMCSA upon request.
            </p>
          </div>
